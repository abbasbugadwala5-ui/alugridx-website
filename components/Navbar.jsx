...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Main header */}
      <header className={`sticky top-0 z-50 bg-white border-b border-border transition-shadow duration-300 ${scrolled ? 'header-scrolled' : ''}`}>
          ...
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <Link href="/" className="flex items-center gap-2.5 flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-[9px] text-muted tracking-widest uppercase">Air Distribution Solutions</p>
              </div>
            </Link>
