        ...
        <section className="section section-light">
          <div className="container">
            ...
            {loading ? (
              ...
              <>
                {featured && (
                  <div className="card overflow-hidden mb-10 group reveal">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                      <div className="relative aspect-[4/3] lg:aspect-auto bg-offwhite">
                        <Image src={featured.img || FALLBACK_IMG} alt={featured.title} fill className="object-cover product-card-img" />
                      </div>
                      <div className="p-8 lg:p-10 flex flex-col justify-center">
                        ...
                        <h2 className="font-heading font-bold text-ink text-2xl md:text-3xl mb-3 group-hover:text-accent transition-colors leading-snug">
                          {featured.title}
                        </h2>
                    ...
                    {rest.map((post, i) => (
                      <div key={post._id} className={`card overflow-hidden group hover:border-accent transition-colors reveal delay-${Math.min((i % 6) + 1, 6)}`}>
                        <div className="relative aspect-[4/3] overflow-hidden bg-offwhite">
                          <Image src={post.img || FALLBACK_IMG} alt={post.title} fill className="object-cover product-card-img" />
                        </div>
                        <div className="p-5">
