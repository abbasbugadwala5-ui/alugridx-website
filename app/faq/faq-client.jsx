        ...
        <section className="section section-light">
          <div className="container max-w-3xl">
            ...
            {loading ? (
              ...
              <>
                {/* JSON-LD FAQ schema — only emitted when FAQs are loaded */}
                <script
                    ...
                    return (
                      <div key={faq._id}>
                        <button
                          ...
                          className="w-full flex items-start justify-between gap-4 sm:gap-5 px-4 sm:px-5 md:px-6 py-4 sm:py-5 text-left hover:bg-offwhite transition-colors"
                          aria-expanded={isOpen}
                        >
                          <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
                            <span className="font-heading font-semibold text-muted text-xs tabular-nums mt-1 w-5 sm:w-6 flex-shrink-0">
                              {String(i + 1).padStart(2, '0')}
                            </span>
                            <span className="font-heading font-semibold text-ink text-sm sm:text-[15px] md:text-base leading-snug break-words">
                              {faq.question}
                            </span>
                          </div>
                          <Plus
                        ...
                        <div className={`faq-answer ${isOpen ? 'open' : ''}`}>
                          <div className="px-4 sm:px-5 md:px-6 pb-5 pl-12 sm:pl-14 md:pl-[3.75rem]">
            ...
            <div className="mt-10 sm:mt-12 card-static p-6 sm:p-8 md:p-10 text-center bg-white reveal">
              <h3 className="font-heading font-semibold text-ink text-lg sm:text-xl mb-2">Still have questions?</h3>
